...
LOGGER_OBJECT_DETECTION_ASYNC_RECORD_VIDEO = 'obj_detector_async_record_video'
LOGGER_OBJECT_DETECTION_ASYNC_SAVE_PICTURE = 'obj_detector_async_save_picture'
LOGGER_OBJECT_DETECTION_TRACKED_OBJECT_PROPERTY_UPDATE = 'obj_detector_tracked_object_property'
